(function ($) {
  ...
  if ($("#testimonials-one__thumb").length) {
    ...
    let testimonialsCarouselImage = new Swiper("#testimonials-one__carousel__image", {
      observer: true,
      loop: true,
      speed: 1400,
      slidesPerView: 1,
    ...
    testimonialsCarouselImage.controller.control = testimonialsThumb;
    testimonialsCarousel.controller.control = testimonialsThumb;
    testimonialsThumb.controller.control = [testimonialsCarousel, testimonialsCarouselImage];
  }
